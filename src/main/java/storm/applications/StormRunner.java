...
public class StormRunner {
     ...
     */
    public static void runTopologyLocally(FlinkTopology topology, String topologyName,
        ...
        try {
            ...
            LOG.info("Topology {} error", topologyName);
        }
     ...
     */
    public static void runTopologyRemotely(FlinkTopology topology, String topologyName,
